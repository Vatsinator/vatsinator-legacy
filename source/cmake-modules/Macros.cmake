...
macro (vatsinator_subdirectory_headers SUBDIR HEADERS)
  if (NOT "${HEADERS}" STREQUAL "")
    set (vatsinator_${SUBDIR}_HEADERS
        ${vatsinator_${SUBDIR}_HEADERS} ${SRCS})
  endif ()
endmacro (vatsinator_subdirectory_headers)
