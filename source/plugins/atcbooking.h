...
public:
    ...
    inline bool isTrainingSession() const
    {
        return __trainingSession;
    }
    
    void setBookedDay(const QDate& bookedDay);
    inline const QDate& bookedDay() const
    {
        return __bookedDay;
    }
    
    void setTimeFrom(const QTime& timeFrom);
    inline const QTime& timeFrom() const
    {
        return __timeFrom;
    }
    
    void setTimeTo(const QTime& timeTo);
    inline const QTime& timeTo() const
    {
        return __timeTo;
    }
